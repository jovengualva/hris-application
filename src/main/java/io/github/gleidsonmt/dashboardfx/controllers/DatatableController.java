...
import io.github.gleidsonmt.dashboardfx.model.Employee;
 ...
 */
public class DatatableController extends ActionView {

    @FXML
    private TableView<Employee> tvCountries;

    @FXML
    private void addRow(ActionEvent event) {
        ObservableList<Employee> data;
        data = tvCountries.getItems();
